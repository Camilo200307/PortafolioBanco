...
public class PortafolioPrestadorDeServiciosFactory implements AbstractFactoryPortafolio {

    private AprobadorDeCreditos aprobador;

    public PortafolioPrestadorDeServiciosFactory(AprobadorDeCreditos aprobador) {
